...
require_once("models/dbModel.php");
	...
	if(isset($_POST['title'])&&isset($_POST['address'])&&isset($_POST['content'])){
		...
		$db=new DB();
		$result=$db->query("INSERT INTO article(aTitle,aSubtitle,aContent,amemberId) 
						VALUES('".$title."','".$address."','".$content."','".$_SESSION['member']['mid']."')");	
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <form action='' id='form_add' method='post'>
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">午食行部落NoonFood新增文</a>
            </div>
                ...
                <div class="well">
                    <h4>內容CONTENT:</h4>
                        ...
                        <div class="form-group">
                            <textarea class="form-control" rows="3"  id="comment_text"  name="content"></textarea>
                        </div>
