...
<body>
    ...
    <header class="intro-header" style="background-image: url('img/<?php echo "465300145.jpg"?>')">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="site-heading">
                        <h1><a  id='a_rand' onClick="relo();">要吃甚麼?</a></h1>
                        <hr class="small">
            ...
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                <?php foreach($article as $a){?>
          		<div class="post-preview">
                    <a href="article.php?id=<?php echo $a['aId'];?>">
                        <h2 class="post-title">
                            <?php echo $a['aTitle'];?>
                        </h2>
